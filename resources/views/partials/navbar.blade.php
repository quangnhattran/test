        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="/threads" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @foreach ($channels as $channel)
                            <a class="dropdown-item" href="/threads?channel={{$channel->name}}">{{$channel->name}}</a>
                        @endforeach
                    </div>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link" href="/threads" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-bell"></i>
                        </a>
                        
                            <div class="dropdown-menu notification" aria-labelledby="navbarDropdown">
                            @foreach (auth()->user()->unreadnotifications as $notification)
                                <a class="dropdown-item" href="/users/{{$notification->id}}">{{$notification->data['message']}}</a>
                            @endforeach
                            </div>
